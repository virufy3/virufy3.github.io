// var Highcharts = { maps: { 'custom/world-robinson-highres': { } } }
...
const america = origin.features.filter((item) => {
  return (
    (item.properties.continent === "North America" ||
      item.properties.continent === "South America") &&
    item.properties.name !== "Canada" &&
    item.properties.name !== "Greenland"
  );
});
origin.features = america;
